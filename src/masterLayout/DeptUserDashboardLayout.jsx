...
const DeptUserDashboardLayout = ({ children }) => {
  ...
  const handleLogout = () => {
    localStorage.removeItem("deptUserToken");
    localStorage.removeItem("DeptUserEmail");
  ...
  return (
    <section className={mobileMenu ? "overlay active" : "overlay "}>
      ...
      >
        ...
        <div>
          <Link to="/deptUserDashboard" className="sidebar-logo">
        ...
        <div className="sidebar-menu-area">
          <ul className="sidebar-menu" id="sidebar-menu">
            <li className="">
              <NavLink
                to="/deptUserDashboard"
                className={(navData) => (navData.isActive ? "active-page" : "")}
              >
                <Icon icon="iconoir:add-user" className="menu-icon" />
                <span>Request</span>
              </NavLink>
            </li>
...
export default DeptUserDashboardLayout;
